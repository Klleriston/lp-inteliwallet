...
export default function Features() {
  ...
  const features = [
    {
      icon: Table2,
      titleKey: "items.spreadsheet.title",
      descriptionKey: "items.spreadsheet.description",
      color: "text-purple-400"
    },
    {
      icon: Users,
      titleKey: "items.multiuser.title",
      descriptionKey: "items.multiuser.description",
    ...
    {
      icon: Zap,
      titleKey: "items.sync.title",
      descriptionKey: "items.sync.description",
      color: "text-neon-blue"
    },
    {
      icon: Smartphone,
      titleKey: "items.access.title",
      descriptionKey: "items.access.description",
      color: "text-purple-400"
    }
  ];
